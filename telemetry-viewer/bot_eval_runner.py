            ...
            records.append(
                {
                    ...
                    "recoveryInputMethod": item.get("recoveryInputMethod"),
                    "targetPoint": item.get("targetPoint"),
                    "targetRect": item.get("targetRect"),
                    ...
                    "selectedRuneLiteWindow": item.get("selectedRuneLiteWindow"),
                    "clickedWindowAtTarget": item.get("clickedWindowAtTarget"),
                    "clickedWindowMatchesSelected": item.get("clickedWindowMatchesSelected"),
                    "beforeScreenshotPath": item.get("beforeScreenshotPath"),
                    "afterMoveScreenshotPath": item.get("afterMoveScreenshotPath"),
                    "afterClickScreenshotPath": item.get("afterClickScreenshotPath"),
        ...
        candidates.append(
            {
                ...
                "routeGuideReentryAttempted": target_explanation.get("routeGuideReentryAttempted"),
                "routeGuideReentryStatus": target_explanation.get("routeGuideReentryStatus"),
                "routeGuideReentryName": target_explanation.get("routeGuideReentryName"),
                "routeGuideReentryCandidate": target_explanation.get("routeGuideReentryCandidate"),
                "postRecoveryContextHydrated": target_explanation.get("postRecoveryContextHydrated"),
                "hydrationSource": target_explanation.get("hydrationSource"),
                "freshSnapshotTick": target_explanation.get("freshSnapshotTick"),
                "freshExportSeq": target_explanation.get("freshExportSeq"),
                "freshPlayerWorldPosition": target_explanation.get("freshPlayerWorldPosition"),
                "freshPlane": target_explanation.get("freshPlane"),
                "hydrationBlockers": target_explanation.get("hydrationBlockers"),
                "hydrationWarnings": target_explanation.get("hydrationWarnings"),
                "warnings": item.get("warnings") or [],
                "missingCapabilities": item.get("missingCapabilities") or [],
            }
        )
