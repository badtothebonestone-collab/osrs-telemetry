...
def _recovery_click_attempts(payload: dict[str, Any], command: list[str]) -> list[dict[str, Any]]:
    ...
    metadata = {
        ...
        "visibleButtonScanAttempted": bool(payload.get("visibleButtonScanAttempted")),
        "visibleButtonsFound": payload.get("visibleButtonsFound") or [],
        "visibleSafeButtonFound": bool(payload.get("visibleSafeButtonFound")),
        "visibleSafeButtonClicked": bool(payload.get("visibleSafeButtonClicked")),
        "visibleButtonClickDetails": payload.get("visibleButtonClickDetails") or [],
        "visibleButtonClickBlocked": bool(payload.get("visibleButtonClickBlocked")),
