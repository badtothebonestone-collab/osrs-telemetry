...
def explain_candidate(
    ...
    *,
    ...
    return {
        ...
        "interactionType": target.get("interactionType"),
        "floorSelectionOption": target.get("floorSelectionOption"),
        "sourcePlane": target.get("sourcePlane"),
        "destinationPlane": target.get("destinationPlane"),
        "allowedSourcePlanes": _list(target.get("allowedSourcePlanes")),
        ...
        "routeName": target.get("routeName"),
        ...
        "routeGuideProgressIndex": target.get("routeGuideProgressIndex"),
        "nextGuidePoint": target.get("nextGuidePoint") if isinstance(target.get("nextGuidePoint"), dict) else None,
        "nextGuideInteraction": target.get("nextGuideInteraction") if isinstance(target.get("nextGuideInteraction"), dict) else None,
        "proposedObjectClassification": target.get("proposedObjectClassification"),
        "routeObjectClassification": target.get("routeObjectClassification"),
        "gateCandidateStatus": target.get("gateCandidateStatus"),
        "rejectedRouteObjectCandidate": target.get("rejectedRouteObjectCandidate") if isinstance(target.get("rejectedRouteObjectCandidate"), dict) else None,
        "selectedCandidateReason": target.get("selectedCandidateReason"),
        "routeObjectReacquired": target.get("routeObjectReacquired"),
        "reacquiredTargetSource": target.get("reacquiredTargetSource"),
        "matchedObjectId": target.get("matchedObjectId"),
        "matchedWorld": target.get("matchedWorld") if isinstance(target.get("matchedWorld"), dict) else None,
        "matchedPlane": target.get("matchedPlane"),
        "matchedAction": target.get("matchedAction"),
        "geometrySource": target.get("geometrySource"),
        "clickPointSource": target.get("clickPointSource"),
        "routeGuideReentry": target.get("routeGuideReentry") if isinstance(target.get("routeGuideReentry"), dict) else None,
        "routeGuideReentryAttempted": target.get("routeGuideReentryAttempted"),
        "currentWorld": target.get("currentWorld") if isinstance(target.get("currentWorld"), dict) else None,
        "currentPlane": target.get("currentPlane"),
        "nearestSamePlaneGuidePoint": target.get("nearestSamePlaneGuidePoint") if isinstance(target.get("nearestSamePlaneGuidePoint"), dict) else None,
        "nearestSamePlaneInteraction": target.get("nearestSamePlaneInteraction") if isinstance(target.get("nearestSamePlaneInteraction"), dict) else None,
        "nearestFloorSelectionInteraction": target.get("nearestFloorSelectionInteraction") if isinstance(target.get("nearestFloorSelectionInteraction"), dict) else None,
        "directPlaneSkipEvidence": target.get("directPlaneSkipEvidence") if isinstance(target.get("directPlaneSkipEvidence"), dict) else None,
        "inferredSubsegment": target.get("inferredSubsegment") if isinstance(target.get("inferredSubsegment"), dict) else None,
        "nextRecoveryStep": target.get("nextRecoveryStep") if isinstance(target.get("nextRecoveryStep"), dict) else None,
        "recoveryCandidateType": target.get("recoveryCandidateType"),
        "intermediateRouteState": target.get("intermediateRouteState"),
        "postRecoveryContextHydrated": target.get("postRecoveryContextHydrated"),
        "hydrationAttemptedAt": target.get("hydrationAttemptedAt"),
        "hydrationSource": target.get("hydrationSource"),
        "freshSnapshotTick": target.get("freshSnapshotTick"),
        "freshExportSeq": target.get("freshExportSeq"),
        "freshPlayerWorldPosition": target.get("freshPlayerWorldPosition") if isinstance(target.get("freshPlayerWorldPosition"), dict) else None,
        "freshPlane": target.get("freshPlane"),
        "freshArea": target.get("freshArea"),
        "routeGuideReentryStatus": target.get("routeGuideReentryStatus"),
        "routeGuideReentryName": target.get("routeGuideReentryName"),
        "routeGuideReentryCandidate": target.get("routeGuideReentryCandidate"),
        "hydrationBlockers": _list(target.get("hydrationBlockers")),
        "hydrationWarnings": _list(target.get("hydrationWarnings")),
        "invalidForExecution": target.get("invalidForExecution"),
        "invalidReason": target.get("invalidReason"),
        "invalidRouteEvidence": target.get("invalidRouteEvidence") if isinstance(target.get("invalidRouteEvidence"), dict) else None,
        "blocker": target.get("blocker"),
        "likelyReason": target.get("likelyReason"),
        "suggestedFixture": target.get("suggestedFixture"),
        "safeState": target.get("safeState"),
