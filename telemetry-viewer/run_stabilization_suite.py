...
COMMANDS = [
    ...
    [sys.executable, "-m", "py_compile", "telemetry-viewer\\task_script_api.py"],
    ...
    [sys.executable, "-m", "py_compile", "telemetry-viewer\\liveness_recovery_core.py"],
    ...
    [sys.executable, "-m", "py_compile", "telemetry-viewer\\tools\\run_traced_dev_cycle.py"],
    ...
    [sys.executable, "telemetry-viewer\\tests\\test_task_script_api.py"],
    ...
    [sys.executable, "telemetry-viewer\\tests\\test_liveness_recovery_core.py"],
    ...
    [sys.executable, "telemetry-viewer\\tests\\test_run_traced_dev_cycle.py"],
