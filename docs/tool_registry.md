...
| `task_script_api.py` | High-level task script primitive contract, validation, compile, evidence planning, runtime evidence snapshots, explanation, and templates. | MCP: `get_task_script_api_spec`, `validate_task_script`, `compile_task_script`, `get_task_script_evidence_plan`, `get_task_script_runtime_evidence` |
