...
| `context_service.py` | Query-first current context, blocker explanations, navigation decision trace summaries, and task-script readiness snapshots. | `python telemetry-viewer\context_service.py --query current-debug-context`; `python telemetry-viewer\context_service.py --query navigation-decision-trace`; `python telemetry-viewer\context_service.py --query task-script-run-readiness`; MCP: `query_navigation_decision_trace` |
