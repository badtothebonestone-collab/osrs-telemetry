...
| `task_script_api.py` | High-level task script primitive contract, validation, compile, explanation, and templates. | MCP: `get_task_script_api_spec`, `validate_task_script`, `compile_task_script`, `explain_script_plan` |
