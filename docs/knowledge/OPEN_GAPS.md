...
| authenticated_start_game_missing | high | startup/recovery | partially_resolved | Use the existing safe recovery/launcher session path to clear disconnected/login, then rerun context_service.py --ensure-loaded-scene until loadedSceneVerified=true before live actions. |
